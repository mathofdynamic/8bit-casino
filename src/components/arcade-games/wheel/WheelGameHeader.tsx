...
export const WheelGameHeader: React.FC<WheelGameHeaderProps> = ({ onBack }) => {
  return (
      ...
      <div>
        <div className="flex items-center gap-2 mb-1 flex-wrap">
          ...
          <div className="flex gap-1.5 flex-wrap">
            <CasinoBadge variant="cyan">16 SEGMENTS</CasinoBadge>
            <CasinoBadge variant="gold">UP TO 10×</CasinoBadge>
        ...
        <p className="font-jersey text-sm text-[#9A9AB5] uppercase mt-1">
          Set a play-money bet and spin for a multiplier from zero to ten times.
        </p>
      </div>
